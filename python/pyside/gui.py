...
class TabDialog(QtGui.QDialog):
    def __init__(self, fileName, parent=None, callbacks=None):
        super(TabDialog, self).__init__(parent)

        fileInfo = QtCore.QFileInfo(fileName) #hei
        self.superSlots = slotclass
        ...
        buttonBox.accepted.connect(self.superSlots.testSlot)
        ...
        self.setWindowTitle("Power Profiling Kit")
...
class GeneralTab(QtGui.QWidget):
    def __init__(self, fileInfo, parent=None):
        ...
        fileNameEdit = QtGui.QLineEdit(fileInfo.filePath())
